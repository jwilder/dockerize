...
* [linux/amd64](https://github.com/jwilder/dockerize/releases/download/v0.12.0/dockerize-linux-amd64-v0.12.0.tar.gz)
* [linux/armel](https://github.com/jwilder/dockerize/releases/download/v0.12.0/dockerize-linux-armel-v0.12.0.tar.gz)
* [linux/arm64](https://github.com/jwilder/dockerize/releases/download/v0.12.0/dockerize-linux-arm64-v0.12.0.tar.gz)
* [linux/armhf](https://github.com/jwilder/dockerize/releases/download/v0.12.0/dockerize-linux-armhf-v0.12.0.tar.gz)
* [alpine/amd64](https://github.com/jwilder/dockerize/releases/download/v0.12.0/dockerize-alpine-linux-amd64-v0.12.0.tar.gz)
* [darwin/amd64](https://github.com/jwilder/dockerize/releases/download/v0.12.0/dockerize-darwin-amd64-v0.12.0.tar.gz)
* [darwin/arm64](https://github.com/jwilder/dockerize/releases/download/v0.12.0/dockerize-darwin-arm64-v0.12.0.tar.gz)
